...
router.get("/", function(req, res, next) {
    db.getConnection(function(err, connection) {
        ...
        if (ID_Usuario != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "ID_Usuario	" + "=" + ID_Usuario; }
        if (Email != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Email	" + "=" + Email; }
        if (Nombre != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Nombre	" + "=" + Nombre; }
        if (Password != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Password	" + "=" + Password; }
        if (EsFacebook != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "EsFacebook	" + "=" + EsFacebook; }
        if (EsGoogle != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "EsGoogle	" + "=" + EsGoogle; }
        if (EsMail != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "EsMail	" + "=" + EsMail; }
        if (Activo != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Activo	" + "=" + Activo; }
        if (Id_Rol != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Id_Rol	" + "=" + Id_Rol; }
        if (DNI != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "DNI	" + "=" + DNI; }
        if (Direccion != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Direccion	" + "=" + Direccion; }
        if (Id_MetodoPago != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Id_MetodoPago	" + "=" + Id_MetodoPago; }
        if (Strikes != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Strikes	" + "=" + Strikes; }
        if (Banned != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "Banned	" + "=" + Banned; }
        if (N_Post != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
            consulta = consulta + "N_Post	" + "=" + N_Post; }
        if (Usuario != 'NULL') { if (primero == false) { consulta = consulta + " AND "; } else { primero = false;
                consulta = consulta + " WHERE "; }
...
router.put("/updateusuario", function(req, res, next) {
    db.getConnection(function(err, connection) {
        ...
        if (ID_Usuario != 'NULL') {
            if (Email != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Email=";
                consulta = consulta + Email; }
            if (Nombre != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Nombre=";
                consulta = consulta + Nombre; }
            if (Password != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Password=";
                consulta = consulta + Password; }
            if (EsFacebook != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "EsFacebook=";
                consulta = consulta + EsFacebook; }
            if (EsGoogle != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "EsGoogle=";
                consulta = consulta + EsGoogle; }
            if (EsMail != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "EsMail=";
                consulta = consulta + EsMail; }
            if (Activo != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Activo=";
                consulta = consulta + Activo; }
            if (Id_Rol != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Id_Rol=";
                consulta = consulta + Id_Rol; }
            if (DNI != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "DNI=";
                consulta = consulta + DNI; }
            if (Direccion != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Direccion=";
                consulta = consulta + Direccion; }
            if (Id_MetodoPago != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Id_MetodoPago=";
                consulta = consulta + Id_MetodoPago; }
            if (Strikes != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Strikes=";
                consulta = consulta + Strikes; }
            if (Banned != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "Banned=";
                consulta = consulta + Banned; }
            if (N_Post != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
                consulta = consulta + "N_Post=";
                consulta = consulta + N_Post; }
            if (Usuario != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
...
router.post("/subeusuario", function(req, res, next) {
    db.getConnection(function(err, connection) {
        if (err) throw err;
        var ID_Usuario = connection.escape(req.body.ID_Usuario)
        var Email = connection.escape(req.body.Email)
        ...
        if (ID_Usuario != 'NULL') { if (primero == false) { consulta = consulta + ","; } else { primero = false; }
